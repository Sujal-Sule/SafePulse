      ...
      >
        ...
        >
          ...
          >
            ...
            <div>
              <p className="text-xs font-medium mb-0.5" style={{ color: "rgba(245,245,245,0.8)" }}>SafePulse Alert</p>
              <p className="text-xs" style={{ color: "rgba(245,245,245,0.38)" }}>SOS triggered — guardians notified</p>
            </div>
            <motion.div
          ...
          >
            ...
            <div>
              <p className="text-xs font-medium mb-0.5" style={{ color: "rgba(245,245,245,0.8)" }}>Admin Dashboard</p>
              <p className="text-xs" style={{ color: "rgba(183,135,245,0.7)" }}>⬤ Live incident — Zone 4B</p>
            </div>
          </motion.div>
        </motion.div>
      </motion.div>
