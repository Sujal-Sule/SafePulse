...
const Navbar = () => {
  ...
  const scrollToSection = (id: string) => {
    // If not on the homepage (e.g., someone went to /login and the navbar is still visible), navigate first
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-8">
        {[
          { label: "The Oracle", id: "oracle" },
          { label: "PathFinder", id: "pathfinder" },
          { label: "The Anchor", id: "anchor" },
          { label: "Failsafe", id: "failsafe" },
          { label: "Silent Witness", id: "silentwitness" }
        ].map((item) => (
          <button
            key={item.id}
