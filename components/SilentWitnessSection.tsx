  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {["Passive Monitoring", "Periodic Check-ins", "Route Deviation", "Reach Safely Prompts"].map((item, i) => (
            <motion.span
              key={item}
        ...
        >
          Passive monitoring with periodic check-ins. Intelligent route deviation detection and automated "Did you reach safely?" prompts.
        </motion.p>
      </motion.div>
    </section>
  );
